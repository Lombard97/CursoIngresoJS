...

{
	...
	while(respuesta!="no")
	{
		...
		{
			positivos = numeros;
			acumuladorp = acumuladorp+positivos;
		...
		{
			negativos = numeros; 
			acumuladorn = acumuladorn+negativos;
		...
		diferencia = acumuladorp - acumuladorn;
			...
			console.log("la suma de los positivos es: "+acumuladorp);
			console.log("la suma de los negativos: "+acumuladorn);
			console.log("cantidad de positivos ingresados: "+contadorp);
			console.log("cantidad de negativos ingresados: "+contadorn);
